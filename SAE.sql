DROP TABLE IF EXISTS import , Lieu , Formation , Etablissement , EffectifCandidat , EffectifAdmission;
...
CREATE SEQUENCE lno START 1;

\! echo "Debut de la ventilation des tables"

CREATE TABLE Lieu(lno, commune, num_departement, nom_departement, nom_region)
AS SELECT DISTINCT nextval('lno'), n9, n5, n6, n7 FROM import;

CREATE TABLE Formation(code_formation, filere_formation, selectivite, capacite , lien_platforme , coordonnees_gps)
AS SELECT n110, n13, n11, n18, n112, n17 FROM import;

CREATE TABLE Etablissement(code_etablissement, nom_etablissement, statut, academie)
AS SELECT DISTINCT n3, n4, n2, n8 FROM import;
...
AS SELECT nextval('ano'), n110, n47, n48, n55, n49, n53, n50, n55, n56, n57, n58, n59, n60 FROM import;

ALTER TABLE Lieu ADD PRIMARY KEY(lno);
